...
body{
 /* background: -webkit-linear-gradient(left, #25c481, #25b7c4);
  ...
  background-image: linear-gradient(to right,#6181CB , #88893C );
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <thead>
        <tr>
          ...
          <th><a titlt="print screen" alt="print screen" onclick="window.print();" target="_blank" style="cursor:pointer;">Print<!-- <center><img src="print.png"></center>--></a></th>
        </tr>
      </thead>
    </table>
  </div>
  ...
  <table>
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td colspan="2"><% out.println((sum*100)/700); %></td>
      </tr>
  </table>
   <!--  <hr class="new1">
